...
import ecust.library.books_query.activity.BooksQueryActivity;
import ecust.main.R;

public class LibraryHomeActivity extends BaseAppCompatActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.library_book_query:
                    startActivity(new Intent(LibraryHomeActivity.this, BooksQueryActivity.class));
                    break;
                default:
